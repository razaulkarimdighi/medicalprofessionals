...
use App\Http\Requests\AnesthesiologistEditRequest;
...
class AnesthesiologistController extends Controller
{
     ...
     */
    public function store(AnesthesiologistRequest $request)
    {
     ...
     */
    public function update(AnesthesiologistEditRequest $request, string $id)
    {
        $data = $request->validated();
        try {
