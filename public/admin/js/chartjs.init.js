        ...
        (r.prototype.init = function () {
                    ...
                    datasets: [
                        {
                            ...
                            pointHitRadius: 10,
                            data: [
                                65, 59, 80, 81, 56, 55, 40, 55, 30, 80, 20, 55,
                            ],
                        },
                        {
                            label: "Free Enrolled",
                            ...
                            pointHitRadius: 10,
                            data: [
                                80, 23, 56, 65, 23, 35, 85, 25, 92, 36, 50, 62,
                            ],
                        },
                    ],
                },
            ...
            this.respChart(d("#pie"), "Pie", {
                ...
                datasets: [
                    {
                        data: [300, 180],
                        backgroundColor: ["#ff64a1", "#ebeff2"],
                        hoverBackgroundColor: ["#5a4ffd", "#ebeff2"],
                        hoverBorderColor: "#fff",
                    },
                ],
            });
                ...
                datasets: [
                    {
                        ...
                        backgroundColor: "#ff64a1",
                        borderColor: "#ff64a1",
                        borderWidth: 1,
                        hoverBackgroundColor: "#ff64a1",
                        hoverBorderColor: "#ff64a1",
                        data: [65, 59, 81, 45, 56, 80, 50, 37, 35, 25, 52, 33],
                    },
                ],
            });
