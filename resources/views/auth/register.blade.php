            ...
            <div class="card w-50">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-2">
                            <label for="user_type" class="col-md-4 col-form-label text-md-end">{{ __('Join As') }}</label>

                            <div class="col-md-6">
                                <select class="form-select" name="user_type" aria-label="Default select example">
                                    <option selected disabled>Select One</option>
                                    <option class="text-capitalize" value="{{ App\Models\User::USER_TYPE_MEDICAL_PRACTICES }}">{{ App\Models\User::USER_TYPE_MEDICAL_PRACTICES }}</option>

                                    <option class="text-capitalize" value="{{ App\Models\User::USER_TYPE_ANESTHEIOLOGISTS }}">{{ App\Models\User::USER_TYPE_ANESTHEIOLOGISTS }}</option>
