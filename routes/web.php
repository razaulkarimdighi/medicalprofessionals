...
Route::prefix('admin')->as('admin.')->group(function () {
    ...
    //Schedule to show anesthesiologist
    Route::get('/get/anesthesiologist/schedule/to/show', [ScheduleController::class,'showAnesthesiologitSchedule'])->name('get.anesthesiologist.schedule');

     //Schedule to show medical practitioner
     Route::get('/get/practitioner/schedule/to/show', [ScheduleController::class,'showMedicalPractitionerSchedule'])->name('get.prectitioner.schedule');
